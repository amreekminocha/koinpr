...
function WalletPublisher() {
    ...
    return (
        <div  style={{ marginTop:"20px" }}>
            ...
            <div style={{ padding: "15px", width: "93%", margin: "auto", display: "flex", justifyContent: "space-between", background:"#F9F9F9"}}>
                ...
                <p>
                    Pending withdrawal : $20
                </p>
            </div>
            <Divider variant='middle' sx={{ width: "93%", margin: "auto", height: "0.3em",  background: "black",marginBottom:"54px" }} />


            <div className=" md:flex lg:flex">
                <div className='md:w-1/3 md:mx-10 sm:w-full' >

                    <Grid sx={{ width: "90%", margin: "auto", background: "#F9F9F9",padding:"2em" }} container spacing={2}>
...
<p style={{fontWeight:600,fontSize:"18px"}}>
                            ...
                            <p style={{ marginBottom: "2em", fontWeight: 600,fontSize:"13px" }}>

                                Please enter the amount
                            </p>
                       
                            <TextField size='small' fullWidth id="outlined-basic" name="amount" value={input.amount} onChange={handleChange} label="Enter Withdrawal Amount" variant="outlined" />
                        </Grid>
                        <Grid item xs={12} md={12}>
                            <p style={{ marginBottom: "2em", marginTop: "2em", fontWeight: 700,fontSize:"13px" }}>
                            ...
                            <Box sx={{ marginTop: "1em" }}>
                                ...
                                size='small'
                                    fullWidth >
                                    <InputLabel id="demo-simple-select-label">Choose your payment method</InputLabel>
                                    <Select
